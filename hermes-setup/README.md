...
> **Сначала прочтите: возможно, установка не нужна.**
>
> Альтернатива — не ставить Hermes на рабочий ПК вообще, а подключаться
> с него к домашнему Hermes WebUI через приватную сеть Tailscale
> (`https://luponarium.tail36f0e3.ts.net/`). Рабочий ПК тогда просто
> клиент: Tailscale + браузер.
>
> Это снимает разом всё, чему посвящён остаток документа: кириллицу в
> `C:\Users\Админ`, выбор каталога, `HERMES_HOME`, отдельный профиль,
> конфликт Telegram-бота между машинами. Один Hermes, одна память, одни
> задачи по расписанию.
>
> Цена: работает только пока домашний ПК включён и в сети. Спящий режим
> дома = нет доступа на работе. Отключите сон, если доступ нужен в
> течение рабочего дня.
>
> Разворачивать по инструкции из задания «Подключить Hermes WebUI на
> рабочем ПК». Документ ниже нужен, только если решено ставить на
> рабочий ПК отдельный экземпляр Hermes.
